...
const Card = styled.div`
    ...
    border-bottom: 1px dashed ${getThemeConfig(['colors', 'borders'])};
    ...
    &:hover, &.active {
        background: ${getThemeConfig(['colors', 'faded', 'background'])};
    }
    ...
    .heading {
        ...
        .icon {
            ...
            &.success {
                color: ${getThemeConfig(['colors', 'intents', 'success', 'text'])};
                background-color: ${getThemeConfig(['colors', 'intents', 'success', 'background'])};
            }
            
            &.danger {
                color: ${getThemeConfig(['colors', 'intents', 'danger', 'text'])};
                background-color: ${getThemeConfig(['colors', 'intents', 'danger', 'background'])};
            }
    ...
    p {
        ...
        line-height: 1.6rem;
        font-size: 1rem;
        color: ${getThemeConfig(['colors', 'lightText'])};
    }
